...
<body>
    ...
    <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6 col-md-6 order-1 order-lg-2 text-end" data-aos="fade-left" data-aos-delay="100">
                        <img src="{{ asset('template/assets/img/abouttb.jpg') }}" class="img-fluid" alt=""
                            style="height: 500px; width: 500px; border-radius: 20px; margin-left: auto" />
                    </div>
        ...
        <section id="why-us" class="why-us bg-dark">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row d-flex justify-content-center mt-5">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="course-item">
                            <img src="{{ asset('template/assets/img/galery4.png') }}" class="img-fluid"
                                alt="..." />
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="course-item">
                            <img src="{{ asset('template/assets/img/galery3.png') }}" class="img-fluid"
                                alt="..." />
                            <div class="course-content">
                                <div class="d-flex justify-content-between align-items-center mb-5">
                                    <!-- <p class="price">$169</p> -->
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="course-item">
                            <img src="{{ asset('template/assets/img/galery2.png') }}" class="img-fluid"
                                alt="..." />
                            <div class="course-content">
                                <div class="d-flex justify-content-between align-items-center mb-5">
                                    <!-- <p class="price">$169</p> -->
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="course-item">
                            <img src="{{ asset('template/assets/img/galery1.png') }}" class="img-fluid"
                                alt="..." />
                            <div class="course-content">
                                <div class="d-flex justify-content-between align-items-center mb-5">
                                    <!-- <p class="price">$169</p> -->
        ...
        <section id="counts" class="counts section-bg" style="background: #e39b0d">
            <div class="container">
                <div class="text-center">
                    <a href="courses.html" class="btn btn-outline-light pe-5 ps-5" style="border-radius: 50px">Artikel
                        dan Info Sekolah</a>
                </div>
            </div>
        </section>
